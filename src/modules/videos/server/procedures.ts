...
export const videosRouter = createTRPCRouter({
  ...
  getManyTrending: baseProcedure
    ...
    .query(async ({ input }) => {
      ...
      const data = await db
        ...
        .innerJoin(users, eq(videos.userId, users.id))
        .where(and(
          eq(videos.visibility, "public"), undefined,
          cursor
            ? or(
  ...
  generateThumbnail: protectedProcedure // TODO: rever codigo integracao com deepseek ou openai
    .input(z.object({ id: z.string().uuid() }))
  ...
  revalidate: protectedProcedure
    ...
    .mutation(async ({ ctx, input }) => {
      ...
      // TODO: Potentially find a way to revalidate track Id and trackStatus as well
